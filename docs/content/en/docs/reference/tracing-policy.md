...
be removed in version 1.5.<br/>
          <br/>
            <i>Enum</i>: Post, FollowFD, UnfollowFD, Sigkill, CopyFD, Override, GetUrl, DnsLookup, NoPost, Signal, TrackSock, UntrackSock, NotifyEnforcer, CleanupEnforcerNotification, Set, ClearGoString, SetGoInt<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>argError</b></td>
